            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="col-md-3 no-padding pull-right">
                        <a href="{{ base_url('scorcard-konvergensi-desa/export/') . $kuartal .'/' . $_tahun . '/' . $id_posyandu }}" id="btnExport" type="button" class="btn pull-right col-md-6  btn-danger">
                            Export ke Excel
                        </a>                        
                    </div>
                </div>
                ...
                <table  id="table-datas" class="table table-bordered table-striped table-responsive">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["periksa_kehamilan"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["periksa_kehamilan"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["pil_fe"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["pil_fe"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["pemeriksaan_nifas"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["pemeriksaan_nifas"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["konseling_gizi"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["konseling_gizi"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["kunjungan_rumah"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["kunjungan_rumah"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["akses_air_bersih"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["akses_air_bersih"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["kepemilikan_jamban"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["kepemilikan_jamban"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["jaminan_kesehatan"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $ibu_hamil["capaianKonvergensi"] == NULL ? "0" : $ibu_hamil["capaianKonvergensi"]["jaminan_kesehatan"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["imunisasi"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["imunisasi"]["persen"] }}</td>
                        </tr>
                        <tr>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">2</th>                            
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengukuran_berat_badan"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengukuran_berat_badan"]["persen"] }}</td>
                        </tr>
                        <tr>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">3</th>                            
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengukuran_tinggi_badan"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengukuran_tinggi_badan"]["persen"] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["kunjungan_rumah"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["kunjungan_rumah"]["persen"] }}</td>
                        </tr>
                        <tr>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">6</th>                            
                            <td colspan="3" style="vertical-align: middle;">Rumah Tangga anak usia 0-23 bulan memiliki sarana akses air minum yang aman</td>
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["air_bersih"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["air_bersih"]["persen"] }}</td>
                        </tr>
                        <tr>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">7</th>                            
                            <td colspan="3" style="vertical-align: middle;">Rumah Tangga anak usia 0-23 bulan memiliki sarana jamban yang layak</td>
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["jamban_sehat"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["jamban_sehat"]["persen"] }}</td>
                        </tr>
                        <tr>
                            <th colspan="1" class="text-center" style="vertical-align: middle;">8</th>                            
                            <td colspan="3" style="vertical-align: middle;">Anak usia 0-23 bulan memiliki akte kelahiran</td>
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["akta_lahir"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["akta_lahir"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["jaminan_kesehatan"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["jaminan_kesehatan"]["persen"] }}</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengasuhan_paud"]["Y"] }}</td>
                            <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $bulanan_anak["capaianKonvergensi"] == NULL ? "0" : $bulanan_anak["capaianKonvergensi"]["pengasuhan_paud"]["persen"] }}</td>
                        </tr>
                        <tr>
...
<script>
    ...
    $('#cari').click(function(){       
        ...
        window.location.href = "{{ base_url('scorcard-konvergensi-desa/tampil/') }}" + kuartal + "/" + tahun + "/" + posyandu;
    });
